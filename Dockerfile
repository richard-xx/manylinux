...
RUN env PYTHON_MAKE_OPTS="-j$(nproc)" PYTHON_CONFIGURE_OPTS="--enable-shared " pyenv install 2.7.18
RUN env PYTHON_MAKE_OPTS="-j$(nproc)" PYTHON_CONFIGURE_OPTS="--enable-shared " pyenv install 3.5.10
RUN env PYTHON_MAKE_OPTS="-j$(nproc)" PYTHON_CONFIGURE_OPTS="--enable-shared " pyenv install 3.6.15
RUN env PYTHON_MAKE_OPTS="-j$(nproc)" PYTHON_CONFIGURE_OPTS="--enable-shared " pyenv install 3.7.12
RUN env PYTHON_MAKE_OPTS="-j$(nproc)" PYTHON_CONFIGURE_OPTS="--enable-shared " pyenv install 3.8.12
RUN env PYTHON_MAKE_OPTS="-j$(nproc)" PYTHON_CONFIGURE_OPTS="--enable-shared " pyenv install 3.9.10
